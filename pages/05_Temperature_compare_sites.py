...
#%%threshold filter
thresholdHigh = st.sidebar.number_input('Set Upper %s threshold:'%stat_select,step=1,min_value=-100, value=100)

thresholdLow = st.sidebar.number_input('Set Lower %s threshold:'%stat_select,step=1,min_value=-100, value=-100)
